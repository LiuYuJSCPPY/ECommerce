...
namespace ECommerce.Web
{
    ...
    //public class ApplicationUserManager : UserManager<ECommerceAdminUser>
    //{
    //    public ApplicationUserManager(IUserStore<ECommerceAdminUser> store)
    //        : base(store)
    //    {
    //    }
    ...
    //    {
    //        var manager = new ApplicationUserManager(new UserStore<ECommerceAdminUser>(context.Get<ECommerceContext>()));
    ...
    //public class ApplicationSignInManager : SignInManager<ECommerceAdminUser, string>
    //{
