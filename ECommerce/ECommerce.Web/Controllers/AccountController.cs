...
namespace ECommerce.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ECommerceUserManager userManager, ECommerceSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ECommerceAdminUser { UserName = model.Email, Email = model.Email };
